...
public partial class PathologyPage : ContentPage
{
    ...
    private readonly PathologyViewModel viewModel;
    public PathologyPage()
    {
        InitializeComponent();

        // Resolve dependencies using DependencyService
        var questionService = new AppService(connectionString);
        viewModel = new PathologyViewModel(questionService);
