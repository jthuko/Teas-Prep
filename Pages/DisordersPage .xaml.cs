...
public partial class DisordersPage : ContentPage
{
    ...
    private readonly DisordersViewModel viewModel;
    public DisordersPage()
    {
        InitializeComponent();

        // Resolve dependencies using DependencyService
        var questionService = new AppService(connectionString);
        viewModel = new DisordersViewModel(questionService);
